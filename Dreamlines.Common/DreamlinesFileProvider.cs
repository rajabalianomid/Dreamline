...
{
    public class DreamlinesFileProvider : PhysicalFileProvider, IDreamlinesFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a DreamlinesFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public DreamlinesFileProvider(IHostingEnvironment hostingEnvironment)
