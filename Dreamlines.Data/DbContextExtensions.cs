using Dreamlines.Data.SampleData;
...
namespace Dreamlines.Data
{
    public static class DbContextExtensions
    {
        ...
        public static void ExecuteSeedFromJsonFile(this IDbContext context, string filePath)
        {
            ...
            context.Set<SalesUnit>().AddRange(data.SalesUnits);
            context.Set<Ship>().AddRange(data.Ships);
            context.Set<Booking>().AddRange(data.Bookings);
            context.SaveChanges();
        }
